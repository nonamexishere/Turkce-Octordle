...
function GameBoards() {
  const { gameWords, gameStatus, usedLetters, dayNumber, toast, hideToast } = useGame();
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="px-4 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg text-sm font-semibold text-white"
              >
                Nasıl Oynanır?
              </button>
